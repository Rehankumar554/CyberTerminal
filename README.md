...
<div class="swiper mySwiper">
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <img
        src="assets/screenshots/theme_hacker_amber.png"
        class="swiper-lazy"
        alt="Screenshot 1"
      />
    ...
    <div class="swiper-slide">
      <img
        src="assets/screenshots/theme_kali.png"
        class="swiper-lazy"
        alt="Screenshot 2"
      />
      <div class="swiper-lazy-preloader"></div>
    ...
    <div class="swiper-slide">
      <img
        src="assets/screenshots/theme_matrix.png"
        class="swiper-lazy"
        alt="Screenshot 3"
      />
      <div class="swiper-lazy-preloader"></div>
    ...
    <div class="swiper-slide">
      <img
        src="assets/screenshots/theme_neon_purple.png"
        class="swiper-lazy"
        alt="Screenshot 4"
      />
      <div class="swiper-lazy-preloader"></div>
    ...
    <div class="swiper-slide">
      <img
        src="assets/screenshots/theme_ubuntu.png"
        class="swiper-lazy"
        alt="Screenshot 4"
      />
      <div class="swiper-lazy-preloader"></div>
...
<script>
  var swiper = new Swiper(".mySwiper", {
    // Optional parameters
    loop: true, // Carousel gol-gol ghumega
    spaceBetween: 30, // Slides ke beech jagah
    centeredSlides: true,
    // Lazy loading enable karein
    lazy: {
      loadPrevNext: true, // Aage piche ki image preload karega
    },
    // Pagination dots
    pagination: {
